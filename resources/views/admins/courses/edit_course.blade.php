                        ...
                        <form action="{{route('updateCourse', $course->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <span>
                                ...
                                @if(isset($course->featured_image))
                                    <img src="{{ asset('/featuredImages/' . $course->featured_image) }}" alt="featured_image" class="featured-image" width="350px">
                                @endif
                            </span>
                            ...
                            <div class="flex items-center justify-end mt-4">
                                <a href="{{route('addCourse')}}" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring focus:ring-gray-300 disabled:opacity-25 transition">Back</a>
